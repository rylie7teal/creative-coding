function setup() {
  ...
  //As part of my expansion on the project, I will make the distribution of squares random at the click of a mouse, essentially reloading the page each time the user clicks
...
function mouseClicked() { //repeating draw() function when the user clicks their mouse
   draw();
}